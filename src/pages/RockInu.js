...
const RockInu = () => {
  return (
    <div className={styles.rockInu}>
      ...
      <a className={styles.whitepaper} href="https://W.W" target="_blank">
        WHITEPAPER
      </a>
      <a className={styles.blockExplorer} href="https://W.B.W" target="_blank">
        BLOCK EXPLORER
      </a>
      ...
      />
      <a className={styles.telegram} href="https://www.g.c" target="_blank">
        Telegram
      </a>
      ...
      />
      <a className={styles.x} href="https://www.x.com/rockinu" target="_blank">
        X
      </a>
      <a className={styles.telegram1} href="https://www.g.c" target="_blank">
        Telegram
      </a>
      <a className={styles.telegram1} href="https://www.g.c" target="_blank">
        Telegram
